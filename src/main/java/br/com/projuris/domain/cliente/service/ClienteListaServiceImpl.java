...
import br.com.projuris.domain.cliente.repository.hand.ClienteListaRepository;
...
public class ClienteListaServiceImpl extends ServiceAbsDefault<Cliente> implements ClienteListaService {
    ...
    @Autowired
    public ClienteListaServiceImpl(ClienteListaRepository clienteListaRepository, ClienteAssembler clienteAssembler) {
    ...
    @Override
    public List<ClienteCompletoResponse> findClienteCompletoResponseAll() {
